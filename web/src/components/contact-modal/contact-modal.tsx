  ...
  return (
    <Modal innerClassName="contact-modal" onRequestClose={onRequestClose}>
      ...
      <Localized id="email-input" attrs={{ label: true }}>
        <LabeledInput label="Email" name="email" placeholder="Enter your email" required type="email" />
      </Localized>

      <Localized id="contact-form-name" attrs={{ label: true }}>
        <LabeledInput label="Name" name="name" placeholder="Enter your name" type="text" />
      </Localized>

      <Localized id="contact-form-message" attrs={{ label: true }}>
        <LabeledTextArea label="Message" name="message" placeholder="Enter your message" required rows={6} />
      </Localized>
